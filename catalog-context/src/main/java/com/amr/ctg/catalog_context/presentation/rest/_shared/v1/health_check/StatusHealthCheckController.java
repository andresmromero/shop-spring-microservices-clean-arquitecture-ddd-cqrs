...
import com.amr.ctg.catalog_context.context.shared.application.cqrs.command.status.CommandStatusCheckerCmd;
...
public class StatusHealthCheckController extends ApiBusController {
    ...
    public ResponseEntity<HashMap<String, String>> healthCheckCommand() {
        ...
        dispatch(new CommandStatusCheckerCmd("catalog-context is up and running, health-check of command, status is ok"));
        HashMap<String, String> status = new HashMap<>();
        status.put("identity-context", "catalog-context");
